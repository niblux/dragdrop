$(document).ready(function(){
	...
	$(".realityT1").click(function(){
		$("#realityTab1").css("display", "block");
		$("#realityTab2").css("display", "none");
		$("#realityTab3").css("display", "none");
		$(".realityT2").css("display", "none");
		$(".realityT3").css("display", "none");		
	});
	$(".realityT2").click(function(){
		$("#realityTab1").css("display", "none");
		$("#realityTab2").css("display", "block");
		$("#realityTab3").css("display", "none");
		$(".realityT3").css("display", "none");
	});
	$(".realityT3").click(function(){
		$("#realityTab1").css("display", "none");
		$("#realityTab2").css("display", "none");
		$("#realityTab3").css("display", "block");
	});
	$(".continueT2").click(function(){
		$(".realityT2").css("display", "block");
		$("#realityTab1").css("display", "none");
		$("#realityTab2").css("display", "block");
		$("#realityTab3").css("display", "none");
	});
	$("#drawdownBut").click(function(){
		$(".realityT3").css("display", "block");
		$("#realityTab1").css("display", "none");
		$("#realityTab2").css("display", "none");
		$("#realityTab3").css("display", "block");
	});
	$("#pensionBut").click(function(){
		$(".realityT3").css("display", "block");
		$("#realityTab1").css("display", "none");
		$("#realityTab2").css("display", "none");
		$("#realityTab3").css("display", "block");
...
$('input[name=taxfree]').click(function () {
    if (this.id == "taxfreeyes") {
        $("#drawdownBut").show('slow');
        $("#pensionBut").show('slow');
        $("#drawdownButTaxfree").hide('slow');
        $("#pensionButTaxfree").hide('slow');
    } else {
        $("#drawdownBut").hide('slow');
        $("#pensionBut").hide('slow');
        $("#drawdownButTaxfree").show('slow');
        $("#pensionButTaxfree").show('slow');
    }
});

$('input[name=test]').click(function () {
    if (this.id == "watch-me") {
        $("#taxfreeyes").show('slow');
    } else {
        $("#taxfreeyes").hide('slow');
    }
});

// #drawdownButTaxfree : hidden on no
// #pensionButTaxfree : hidden on no

// #drawdownBut : hidden on yes
// #pensionBut : hidden on yes
